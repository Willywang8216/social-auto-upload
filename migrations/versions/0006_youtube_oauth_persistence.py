"""youtube oauth persistence

Adds durable storage for YouTube OAuth state tokens so callback processing
survives process restarts and maps back to the saved structured account.

Revision ID: 0006_youtube_oauth_persistence
Revises: 0005_reddit_oauth_persistence
...
revision = "0006_youtube_oauth_persistence"
down_revision = "0005_reddit_oauth_persistence"
branch_labels = None
depends_on = None
...
DROP_STATEMENTS = (
    "DROP TABLE IF EXISTS youtube_oauth_requests",
)
